...
import OperatingSystem, { type OperatingSystemValue } from './OperatingSystem';
import { NOT_AVAILABLE } from '../../CellValue';

const rhelOs: OperatingSystemValue = {
  name: 'RHEL',
  major: 8,
  minor: 10,
};

const centosOs: OperatingSystemValue = {
  name: 'CentOS Linux',
  major: 7,
  minor: 4,
};
...
describe('OperatingSystem cell', () => {
  ...
  it('should show OS name without version for other operating systems', () => {
    const centosStream: OperatingSystemValue = {
      name: 'CentOS Stream',
      major: 7,
      minor: 4,
    };
  ...
  it('should show rhsm when name is missing', () => {
    render(<OperatingSystem value={{ rhsm: '8.10' }} />);
